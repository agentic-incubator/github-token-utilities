...
## How to work in Hermes Agent

- **Asking the user:** Use the `clarify` tool for choices and confirmations.
- **Running commands:** Use the `terminal` tool.
...
- To open a reference file, use `skill_view` with this skill's name and the path (e.g. `references/audit.md`).
